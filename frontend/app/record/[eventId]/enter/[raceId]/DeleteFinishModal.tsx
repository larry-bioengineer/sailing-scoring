...
export type DeleteFinishModalProps = {
  open: boolean;
  onClose: () => void;
  sailNumber: string;
  finishTime: string;
...
export function DeleteFinishModal({
  open,
  onClose,
  sailNumber,
  finishTime,
          ...
          >
            <div>
              ...
              <div className="mt-3 text-center sm:mt-5">
                ...
                >
                  Remove finish record
                </DialogTitle>
                <div className="mt-2">
                  <p className="text-sm text-zinc-500 dark:text-zinc-400">
                    Are you sure you want to remove the finish for sail number{" "}
                    <strong>{sailNumber}</strong> at {finishTime}? This cannot
                    be undone.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
              ...
              >
                {submitting ? "Removing…" : "Remove finish"}
              </button>
              <button
                type="button"
                data-autofocus
