...
export type DeleteRaceModalProps = {
  open: boolean;
  onClose: () => void;
  raceId: string;
  onConfirm: () => void;
        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
              ...
              <div className="mt-3 text-center sm:mt-5">
                ...
                <div className="mt-2">
                  <p className="text-sm text-zinc-500 dark:text-zinc-400">
                    Are you sure you want to remove race <strong>{raceId}</strong>?
                    All finish data for this race will be permanently deleted.
            ...
            <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
              ...
              >
                {submitting ? "Removing…" : "Remove race"}
              </button>
              <button
                type="button"
                data-autofocus
